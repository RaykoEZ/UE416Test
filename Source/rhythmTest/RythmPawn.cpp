...
// Called every frame
void ARythmPawn::Tick(float DeltaTime)
{
...
void ARythmPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Beep", IE_Pressed, this, &ARythmPawn::BeepAction);

}

void ARythmPawn::BeepAction()
{
	audio->Play();
	if (m_onBeat) 
	{
...
void ARythmPawn::setOnBeat(const bool & value)
{
	m_onBeat = value;
